/* The following code was generated by JFlex 1.4.3 on 3/10/18 04:00 AM */
 ...
 * on 3/10/18 04:00 AM from the specification file
...
//Aquí termina el código de Java
   ...
   */
  public Atomos(java.io.Reader in) {
    this.zzReader = in;
  }
   ...
   */
  public Atomos(java.io.InputStream in) {
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java Atomos <inputfile>");
    }
    else {
      for (int i = 0; i < argv.length; i++) {
        Atomos scanner = null;
        try {
          scanner = new Atomos( new java.io.FileReader(argv[i]) );
