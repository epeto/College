...
public class Gatos extends PApplet {
    ...
    class Gato{
        ...
        */
        ...
        /**
         * Esta es mi función.
         * Función auxiliar que devuelve la lista de las casillas disponibles.
         * @return puntos
         */
        LinkedList<Point> puntDisp(){
        ...
        */
        LinkedList<Gato> generaSucesores(){
            ...
            boolean jugSig = !jugador1;
            LinkedList<Gato> sucs = new LinkedList<>();
            LinkedList<Point> casillas = puntDisp();
            
            while(!casillas.isEmpty()){
                Gato ejemplar = new Gato(this);
                Point pa = casillas.removeFirst();
                ejemplar.jugador1 = jugSig;
                ejemplar.padre = this;
                ejemplar.tiraEn(pa.x, pa.y);
        ...
        boolean esSimetricoDiagonalInvertida(Gato otro){
            Gato nuevo = new Gato();
            nuevo.tablero[0][0] = otro.tablero[0][0];
            nuevo.tablero[1][0] = otro.tablero[0][1];
            nuevo.tablero[2][0] = otro.tablero[0][2];
            nuevo.tablero[0][1] = otro.tablero[1][0];
            nuevo.tablero[1][1] = otro.tablero[1][1];
            nuevo.tablero[2][1] = otro.tablero[1][2];
            nuevo.tablero[0][2] = otro.tablero[2][0];
            nuevo.tablero[1][2] = otro.tablero[2][1];
            nuevo.tablero[2][2] = otro.tablero[2][2];
            return esIgual(nuevo);
        }

        /** Al reflejar el gato sobre la diagonal / son iguales (ie traspuesta) */
        boolean esSimetricoDiagonal(Gato otro){
            Gato nuevo = new Gato();
            nuevo.tablero[0][0] = otro.tablero[2][2];
            nuevo.tablero[1][0] = otro.tablero[2][1];
            nuevo.tablero[2][0] = otro.tablero[2][0];
            nuevo.tablero[0][1] = otro.tablero[1][2];
            nuevo.tablero[1][1] = otro.tablero[1][1];
            nuevo.tablero[2][1] = otro.tablero[1][0];
            nuevo.tablero[0][2] = otro.tablero[0][2];
            nuevo.tablero[1][2] = otro.tablero[0][1];
            nuevo.tablero[2][2] = otro.tablero[0][0];
            return esIgual(nuevo);
        }
        ...
        boolean esSimetricoVerticalmente(Gato otro){
            Gato nuevo = new Gato();
            nuevo.tablero[0][0] = otro.tablero[2][0];
            nuevo.tablero[1][0] = otro.tablero[1][0];
            nuevo.tablero[2][0] = otro.tablero[0][0];
            nuevo.tablero[0][1] = otro.tablero[2][1];
            nuevo.tablero[1][1] = otro.tablero[1][1];
            nuevo.tablero[2][1] = otro.tablero[0][1];
            nuevo.tablero[0][2] = otro.tablero[2][2];
            nuevo.tablero[1][2] = otro.tablero[1][2];
            nuevo.tablero[2][2] = otro.tablero[0][2];
            return esIgual(nuevo);
        }
        ...
        boolean esSimetricoHorizontalmente(Gato otro){
            Gato nuevo = new Gato();
            nuevo.tablero[0][0] = otro.tablero[0][2];
            nuevo.tablero[1][0] = otro.tablero[1][2];
            nuevo.tablero[2][0] = otro.tablero[2][2];
            nuevo.tablero[0][1] = otro.tablero[0][1];
            nuevo.tablero[1][1] = otro.tablero[1][1];
            nuevo.tablero[2][1] = otro.tablero[2][1];
            nuevo.tablero[0][2] = otro.tablero[0][0];
            nuevo.tablero[1][2] = otro.tablero[1][0];
            nuevo.tablero[2][2] = otro.tablero[2][0];
            return esIgual(nuevo);
        }
