    ...
    class ModeloTermitas{
      ...
      */
      ModeloTermitas(int ancho, int alto, int tamanio, int cantidad, float densidad){
        ...
        for(int i = 0; i < alto; i++)   //altura=100
          for(int j = 0; j < ancho; j++)    //ancho=150
      ...
      */
      int direccionAleatoriaFrente(int direccion){
        ...
        int nuevaDir = direccion + rnd.nextInt(3)-1;
        if(nuevaDir==8)
            nuevaDir=0;
      ...
      */
      boolean hayAstilla(Termita t, int dir){
         ...
         int posActX=t.posX+dx;
         int posActY=t.posY+dy;
         ...
         return mundo[posActY][posActX].estado;
       }
      ...
      */
      void dejarAstillaConSalto(Termita t){
        ...
        mundo[t.posY][t.posX].estado=true;
        t.cargando=false;
        int nuevaX=rnd.nextInt(150);
        int nuevaY=rnd.nextInt(100);
        
        while(mundo[nuevaY][nuevaX].estado){
            nuevaX=rnd.nextInt(150);
            nuevaY=rnd.nextInt(100);
        }
      ...
      /** Simula el proceso en el que una termita recoge una astilla.
        ...
        @param dir direccion en la que se movera. Recoge la astilla
